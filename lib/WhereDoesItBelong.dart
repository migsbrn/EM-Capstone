                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (_) => const GamesLandingPage()),
                          );
                        },
                        child: const Text(
                          "Back to Games",
                ...
                child: Wrap(
                  ...
                  children: items.map((item) {
                    return Draggable<Map<String, String>>(
                      data: item,
                      feedback: Image.asset(item['image']!, width: 120),
                                ...
                                Expanded(
                                  child: Wrap(
                                    ...
                                    children: acceptedItems[category]!
                                        .map((img) => Image.asset(img, width: 100))
                                        .toList(),
                                  ),
                                ),
                                Padding(
                          ...
                          onAcceptWithDetails: (data) {
                            ...
                            if (itemData['category'] == category) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Oops! That item does not belong there.'),
